package com.elthobhy.newsapp.ui.favorite.adapter.general
...
class FavoriteGeneralAdapter: RecyclerView.Adapter<FavoriteGeneralAdapter.FavoriteViewHolder>() {
    private val list = ArrayList<ArticleGeneral>()
    ...
    fun setList(entity: List<ArticleGeneral>) {
        list.clear()
        list.addAll(entity)
