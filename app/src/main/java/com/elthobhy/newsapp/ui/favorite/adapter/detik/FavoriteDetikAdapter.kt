package com.elthobhy.newsapp.ui.favorite.adapter.detik
...
class FavoriteDetikAdapter: RecyclerView.Adapter<FavoriteDetikAdapter.FavoriteViewHolder>() {
    ...
    fun setList(entity: List<ArticleDetik>) {
        list.clear()
        list.addAll(entity)
