package com.elthobhy.newsapp.ui.favorite.adapter.kapanlagi
...
class FavoriteKapanlagiAdapter: RecyclerView.Adapter<FavoriteKapanlagiAdapter.FavoriteViewHolder>() {
    ...
    inner class FavoriteViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(entity: ArticleKapanlagi) {
            binding.apply {
                Glide.with(itemView)
    ...
    fun setList(entity: List<ArticleKapanlagi>) {
        list.clear()
        list.addAll(entity)
