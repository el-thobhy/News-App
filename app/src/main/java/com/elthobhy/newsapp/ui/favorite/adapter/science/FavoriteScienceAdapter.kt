package com.elthobhy.newsapp.ui.favorite.adapter.science
...
class FavoriteScienceAdapter: RecyclerView.Adapter<FavoriteScienceAdapter.FavoriteViewHolder>() {
    private val list = ArrayList<ArticleScience>()
    ...
    fun setList(entity: List<ArticleScience>) {
        list.clear()
        list.addAll(entity)
