package com.elthobhy.newsapp.ui.favorite.adapter.entertainment
...
class FavoriteEntertainmentAdapter: RecyclerView.Adapter<FavoriteEntertainmentAdapter.FavoriteViewHolder>() {
    private val list = ArrayList<ArticleEntertainment>()
    ...
    interface OnItemClickCallback {
        fun onItemClicked(data: ArticleEntertainment)
    }

    inner class FavoriteViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        private val binding = ItemTopHeadlinesBinding.bind(itemView)
        fun bind(entity: ArticleEntertainment) {
            binding.apply {
                Glide.with(itemView)
    ...
    fun setList(entity: List<ArticleEntertainment>) {
        list.clear()
        list.addAll(entity)
