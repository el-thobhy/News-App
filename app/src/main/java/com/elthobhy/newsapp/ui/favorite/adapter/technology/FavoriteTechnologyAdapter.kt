package com.elthobhy.newsapp.ui.favorite.adapter.technology
...
class FavoriteTechnologyAdapter: RecyclerView.Adapter<FavoriteTechnologyAdapter.FavoriteViewHolder>() {
    private val list = ArrayList<ArticleTechnology>()
    ...
    interface OnItemClickCallback {
        fun onItemClicked(data: ArticleTechnology)
    }

    inner class FavoriteViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        private val binding = ItemTopHeadlinesBinding.bind(itemView)
        fun bind(entity: ArticleTechnology) {
            binding.apply {
                Glide.with(itemView)
    ...
    fun setList(entity: List<ArticleTechnology>) {
        list.clear()
        list.addAll(entity)
