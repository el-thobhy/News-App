package com.elthobhy.newsapp.ui.favorite.adapter.health
...
class FavoriteHealthAdapter: RecyclerView.Adapter<FavoriteHealthAdapter.FavoriteViewHolder>() {
    private val list = ArrayList<ArticleHealth>()
    ...
    fun setList(entity: List<ArticleHealth>) {
        list.clear()
        list.addAll(entity)
