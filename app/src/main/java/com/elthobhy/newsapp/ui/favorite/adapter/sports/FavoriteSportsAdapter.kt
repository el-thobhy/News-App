package com.elthobhy.newsapp.ui.favorite.adapter.sports
...
class FavoriteSportsAdapter: RecyclerView.Adapter<FavoriteSportsAdapter.FavoriteViewHolder>() {
    private val list = ArrayList<ArticleSports>()
    ...
    fun setList(entity: List<ArticleSports>) {
        list.clear()
        list.addAll(entity)
